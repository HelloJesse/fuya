...
function onControlDirectionCode(Id, type, controlType, row) {
    ...
    //    if (controlType == 8 || controlType == 16) {
    //        mini.get("#controlId").setValue(5);//升高 or 下降
    //    } else {
    ...
    //        //同个方向累加角度或高度 
    //        if (_TypeId == 8 || _TypeId == 16) {
    //            mini.get("#controlId").setValue(parseInt(mini.get("controlId").getValue()) + 5);//升高 or 下降
    //        } else {
    //            mini.get("#controlId").setValue(parseInt(mini.get("controlId").getValue()) + 2);//左飞 or 右飞 
    //        }
    //    } else {
    //        //改变方向第一次点击判断
    //        if (controlType == 8 || controlType == 16) {
